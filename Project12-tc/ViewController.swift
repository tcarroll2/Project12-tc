        ...
        switch currentAnimation {
            ...
            case 12:
                NSAnimationContext.runAnimationGroup({
                    [unowned self] ctx in ctx.duration = 1
                    self.imageView.animator().isHidden = true }, completionHandler: { [unowned self] in self.view.layer?.backgroundColor = NSColor.red.cgColor })
            case 13:
